...
<body>
	...
	<div class="container">
		<h3 class="display-4 text-center" style="padding-bottom: 1rem; font-size: 2.5rem;">Connect to Azure SQL Database</h3>
		...
		<form name="form" action="database.php" method="post">
			<div class="row justify-content-center">
				<div class="form-group col-5">
				    ...
				    <small id="accountHelp" class="form-text text-muted">Your Azure SQL Server Name</small>
				</div>
				</div>
			<div class="row justify-content-center">
				<div class="form-group col-5">
				    ...
				    <small id="accountHelp" class="form-text text-muted">Your Azure SQL Database Name</small>
				</div>
				</div>
			<div class="row justify-content-center">
				<div class="form-group col-5">
				    ...
				    <small id="accountHelp" class="form-text text-muted">Your Azure SQL User Name</small>
				</div>
				</div>
			<div class="row justify-content-center">
				<div class="form-group col-5">
